...
void Lab4::RenderScene() {
    ...
    modelMatrix *= transform3D::Translate(-2.8f, 0.0f, 0.0f);
    modelMatrix *= transform3D::RotateOZ(angularStepOrbit);
    modelMatrix *= transform3D::Translate(-2.2f, 0.0f, -3.5f);
    modelMatrix *= transform3D::Translate(0.0f, 0.0f, -1.5f);
    modelMatrix *= transform3D::RotateOX(angularStepOrbit);
    modelMatrix *= transform3D::Translate(0.0f, 0.0f, 1.5f);
...
void Lab4::Update(float deltaTimeSeconds)
{
    ...
    angularStepOrbit -= deltaTimeSeconds * 4;
}
...
void Lab4::OnKeyPress(int key, int mods)
{
    ...
    if (key == GLFW_KEY_U)
    {
        miniViewportArea.x -= 25;
        miniViewportArea.width += 50;

        miniViewportArea.y -= 25;
